...
El proyecto cuenta con un login y una sección para crearse una cuenta. Una vez logueado, el usuario accede a un menú que permite elegir entre 3 juegos , un tragamonedas, una ruleta y un Black Jack <b>_(actualmente solo se encuentra finalizado el tragamonedas)_</b> . También cuenta con una barra de navegación que permite dirigirse a distintas secciones y una pequeña sección que muestra el nombre de usuario logueado y el saldo.
...
8. Tragamonedas (juegoTragamonedas.html)<br>
   Corresponde al juego del tragamonedas. <b>_(COMPLETO)_</b>
